class Scene5 extends Phaser.Scene {
    ...
    .catch(console.error);
    */
        this.background = this.add.tileSprite(0,0, config.width, 200, "lvl4_bg");
        ...
        this.bonus = this.physics.add.sprite(config.width, config.heigth, "orcs");
        ...
        const music = this.sound.add("lvl4_sound", {
            mute: false,
            volume: 1,
            rate: 1,
            detune: 0,
    ...
    collideBonus(dog, bonus) {
        ...
        const space_module = this.sound.add("waaagh", {
            mute: false,
            volume: 3,
            rate: 1,
            detune: 0,
    ...
    loseFunc()
    {
        this.scene.start("Lose", ["lvl4",this.bonus_before]);
        this.sound.removeByKey('lvl4_sound');
    }

    winFunc(data){
        this.bonus_on_this_lvl+=data;
        this.scene.start("Finish", this.bonus_on_this_lvl);
        this.sound.removeByKey('lvl4_sound');
    }
