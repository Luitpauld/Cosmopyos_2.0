class Ending2 extends Phaser.Scene {
    ...
    */
    ...
    ololo4(){
        ...
        this.text1.setVisible(false);
        this.text1 = this.add.text(config.width/2 - 80, config.height - config.height/4 -50,"Нам необходимо активировть\nмаяк, для передачи данных.",
            {fontFamily: 'font1', color: "Black", fontSize:'25px'});
        this.butt4.setVisible(false);
    ...
    ololo5(){
        ...
        this.text1.setVisible(false);
        this.text1 = this.add.text(config.width/2 - 80, config.height - config.height/4 -50,"И ждать. \nЗа нами обязательно прилетят,\nмой друг.",
            {fontFamily: 'font1', color: "Black", fontSize:'25px'});
        this.butt5.setVisible(false);
