class Brif4 extends Phaser.Scene {
    constructor() {
        super("brif4");
    }
    ...
    */
        ...
        this.text1 = this.add.text(config.width/2 - 80, config.height - config.height/4 - 25,"Мои сканеры зафиксировали... \nЛОШАДЬ?!",
        ...
        this.butt5.on("pointerdown", ()=>this.ololo5(data));
    ...
    ololo2(){
        ...
        this.text1.setVisible(false);
        this.text1 = this.add.text(config.width/2 - 80, config.height - config.height/4 -50,"Какой то системный сбой... \nВидимо сканер поврежден.\nЗапускаю проверку системы.",
            {fontFamily: 'font1', color: "Black", fontSize:'25px'});
        this.butt2.setVisible(false);
    ...
    ololo3(){
        ...
        this.text1.setVisible(false);
        this.text1 = this.add.text(config.width/2 - 80, config.height - config.height/4 -50,"В общем, нас опять\nпостигла неудача.\nПланета не пригодна для\nколонизации.",
            {fontFamily: 'font1', color: "Black", fontSize:'25px'});
        this.butt3.setVisible(false);
    ...
    ololo4(){
        this.planet = this.physics.add.sprite(config.width/2 - 50, config.height/3, "earth");
        ...
        this.text1.setVisible(false);
        this.text1 = this.add.text(config.width/2 - 80, config.height - config.height/4 - 40,"Четвертая планета этой системы: \nKepler-22 b.\nНаша последняя надежда.",
            {fontFamily: 'font1', color: "Black", fontSize:'25px'});
        this.butt4.setVisible(false);
