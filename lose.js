class Lose extends Phaser.Scene {
    ...
    */
        ...
        var butt1 = this.add.text(config.width/2 - 120, config.height/2 - 50, "Начать уровень \n         заново", {
            fontFamily: 'font1', fontSize: '30px', color: 'black'
        });
        butt1.setInteractive();
        butt1.on("pointerdown", ()=>this.restart_lvl(data)); 
        ...
        this.add.text(config.width/3 - 80, config.height/7, "МИССИЯ ПРОВАЛЕНА", {
